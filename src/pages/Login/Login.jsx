...
import google_img from '../../assets/images/logo-google.png'
      ...
      <form onSubmit={handlerSubmit}>
        ...
        <a className={styles.btn} onClick={handlerLoginWithGoogle}>
          {/* <svg version="1.1" width="20" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style={{ enableBackground: 'new 0 0 512 512' }}
            xmlSpace="preserve">
...
C318.115,0,375.068,22.126,419.404,58.936z"></path>
          ...
          <img src={google_img} alt="" width={'1%'} />
          Google
        </a>
      </form>
    </div>
